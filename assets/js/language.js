document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ar: { 
      ...
      // Links Page
      links_title: "Axentro | اكسنترو للحلول الرقمية والبرمجية",
      links_desc1: "اختر وسيلة التواصل الأنسب",
      links_desc2: 'وسنرد عليك سريعًا <span class="eye-pill"><span class="eye-dot"></span></span> Choose your preferred contact method.',
